...
autodoc_mock_imports = ["numpy", "scipy", "tkinter", "pandas"]
...
version = '0.0.2'
release = '0.0.2'
author = u'Kenny Larrieu, Sebastian Schwindt'
copyright = author
language = 'en'
...
html_theme_options = {
    ...
    'repository_url': 'https://github.com/sschwindt/las4windows',
